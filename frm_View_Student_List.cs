...
namespace YC_Student_Management_System
{
    public partial class frm_View_Student_List : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'yC_Student_Management_SystemDataSet3.Student_List' table. You can move, or remove it, as needed.
            this.student_ListTableAdapter.Fill(this.yC_Student_Management_SystemDataSet3.Student_List);
